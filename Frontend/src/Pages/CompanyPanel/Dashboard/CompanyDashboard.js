            ...
            <div className={styles.welcomeCard}>
                <div className={styles.welcomeContent}>
                    ...
                    <h1 className={styles.welcomeTitle}>
                        ...
                        <span className={styles.textHighlight}>AI ile Hızlandırın</span>
                    </h1>
                    <p className={styles.welcomeText}>
                        <b>hr.ai</b> platformuna hoş geldiniz. Akıllı algoritmalarımız sayesinde aday filtreleme, yetkinlik analizi ve mülakat organizasyonlarını tek tıkla yönetin.
                    </p>
                    ...
                    <div className={styles.statsContainer}>
                        <div className={styles.statBox}>
                            ...
                            <div className={styles.statInfo}>
                                ...
                                <p>Saniyeler içinde CV tarama</p>
                            </div>
                        </div>
                        <div className={styles.statBox}>
                            <div className={styles.statIcon}>🎯</div>
                            <div className={styles.statInfo}>
                                <h3>Doğru Eşleştirme</h3>
                                <p>İşe en uygun adaylar</p>
                            </div>
                        </div>
                        <div className={styles.statBox}>
                            <div className={styles.statIcon}>📊</div>
